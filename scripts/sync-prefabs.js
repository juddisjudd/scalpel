...
const REPO = 'scalpelpoe/scalpel'
const BRANCH = 'main'
const BASE_URL = `https://raw.githubusercontent.com/${REPO}/${BRANCH}/cheat-sheet-prefabs/`
...
function main() {
  ...
  for (const slug of slugs) {
    ...
    packs.push({ slug, name: packDisplayName(packDir, slug), images })
  }
...
export const PREFAB_BASE_URL = ${JSON.stringify(BASE_URL)}
